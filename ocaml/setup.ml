...
(* OASIS_START *)
(* DO NOT EDIT (digest: cce5ebbac5b4518c0308fb6e0616d652) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$storage_test", []))];
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "xapi-storage";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "storage_test.ml"});
               Test
                 ({
                     cs_name = "storage_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "%(Í\144@Çµæ+\157­\\[V\144J";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
