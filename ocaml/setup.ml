...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a3fc574e0a2369ca0bc2e22e025d31a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("rpclib", None)];
                   ...
                   {
                      lib_modules = ["S"; "Storage"; "Channel"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xapi-idl";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "$.UÂ\145ôö}S¿\130àØõ\137â";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
