...
let bridge_not_available_for_network = "BRIDGE_NOT_AVAILABLE_FOR_NETWORK"
let bridge_already_bound_with_network = "BRIDGE_ALREADY_BOUND_WITH_NETWORK"
let bridge_not_supported_for_network = "BRIDGE_NOT_SUPPORTED_FOR_NETWORK"
