...
let _ =
  Printexc.register_printer (function
      | Server_error(_, _) as e -> Some (to_string e)
      | _ -> None)
...
let server_certificate_key_algorithm_not_supported = "SERVER_CERTIFICATE_KEY_ALGORITHM_NOT_SUPPORTED"
let server_certificate_key_rsa_length_not_supported = "SERVER_CERTIFICATE_KEY_RSA_LENGTH_NOT_SUPPORTED"
let server_certificate_key_rsa_multi_not_supported = "SERVER_CERTIFICATE_KEY_RSA_MULTI_NOT_SUPPORTED"
...
let server_certificate_signature_not_supported = "SERVER_CERTIFICATE_SIGNATURE_NOT_SUPPORTED"
