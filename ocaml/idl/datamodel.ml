  ...
  let t =
    create_obj
      ...
      ~contents:[
        ...
        field ~qualifier:DynamicRO ~ty:(Set (Ref _vgpu_type)) ~lifecycle:[Published, rel_plymouth, ""] "compatible_types_in_vm" "List of VGPU types which are compatible in one VM";
        field ~qualifier:DynamicRO ~ty:(Set (Ref _vgpu_type)) ~lifecycle:[Published, rel_plymouth, ""] ~internal_only:true "compatible_types_on_pgpu" "List of VGPU types which are compatible on one PGPU";
      ]
      ()
end
...
let all_relations =
  [
    ...
    (_vgpu_type, "compatible_types_on_pgpu"), (_vgpu_type, "compatible_types_on_pgpu");
    (_vgpu_type, "compatible_types_in_vm"), (_vgpu_type, "compatible_types_in_vm");
