...
let _ =
  ...
  error Api_errors.xen_vss_req_error_start_snapshot_set_failed [ "vm"; "error-code" ]
    ~doc:"An attempt to start a new VSS snapshot failed" ();
  error Api_errors.xen_vss_req_error_adding_volume_to_snapset_failed [ "vm"; "error-code" ]
  ...
  error Api_errors.xen_vss_req_error_creating_snapshot_xml_string [ "vm"; "error-code" ]
