...
let create =
  call ~name:"create" ~in_oss_since:None ~lifecycle:[]
    ...
    ~params:
      [
        (String, "name_label", "The TracerProvider")
      ; ( Set (Ref _host)
        , "hosts"
        , "Hosts the TracerProvider is to be created on"
        )
      ; (Bool, "status", "The status of the TracerProvider")
      ; (Map (String, String), "tags", "The tags of the TracerProvider")
      ; (Set String, "endpoints", "The endpoints of the TracerProvider")
      ; (Set String, "components", "The componenets of the TracerProvider")
      ; (Set String, "filters", "The filters of the TracerProvider")
      ; (Set String, "processors", "The processors of the TracerProvider")
      ]
...
let destroy =
  call ~name:"destroy" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the fields of a TracerProvider in the Tracing Library"
    ~params:[(Ref _tracing, "self", "The TracerProvider to be destoryed")]
    ~allowed_roles:_R_POOL_ADMIN ()

let set_hosts =
  call ~name:"set_hosts" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the host field of a TracerProvider in the Tracing Library"
    ~params:
      [
...
let set_status =
  call ~name:"set_status" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the status of a TracerProvider in the Tracing Library"
    ~params:
      [
        (Ref _tracing, "self", "The TracerProvider")
...
let set_tags =
  call ~name:"set_tags" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the tags field of a TracerProvider in the Tracing Library"
    ~params:
      [
        (Ref _tracing, "self", "The TracerProvider")
      ; ( Map (String, String)
...
let set_endpoints =
  call ~name:"set_endpoints" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the endpoints field of a TracerProvider in the Tracing Library"
    ~params:
      [
        (Ref _tracing, "self", "The TracerProvider")
      ; ( Set String
...
let set_components =
  call ~name:"set_components" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the components field of a TracerProvider in the Tracing Library"
    ~params:
      [
        (Ref _tracing, "self", "The TracerProvider")
      ; ( Set String
...
let set_filters =
  call ~name:"set_filters" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the filters field of a TracerProvider in the Tracing Library"
    ~params:
      [
        (Ref _tracing, "self", "The TracerProvider")
...
let set_processors =
  call ~name:"set_processors" ~in_oss_since:None ~lifecycle:[]
    ~doc:"Set the processors field of a TracerProvider in the Tracing Library"
    ~params:
      [
        (Ref _tracing, "self", "The TracerProvider")
      ; ( Set String
