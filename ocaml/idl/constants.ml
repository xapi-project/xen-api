...
let get_vm_rrd_uri = "/vm_rrd"                        (* ocaml/rrdd/rrdd_main.ml *)
let rrd_put_uri = "/rrd"                              (* ocaml/rrdd/rrdd_main.ml *)
let rrd_unarchive_uri = "/rrd_unarchive"              (* ocaml/rrdd/rrdd_main.ml *)
let get_host_rrd_uri = "/host_rrd"                    (* ocaml/rrdd/rrdd_main.ml *)
let rrd_updates = "/rrd_updates"                      (* ocaml/rrdd/rrdd_main.ml *)
