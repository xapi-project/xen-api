...
module type DB_ACCESS_FIELD = sig
  type field_in
  ...
  val read_record : Db_ref.t -> table -> db_ref -> field_out db_record
  ...
  val read_records_where :
    ...
    -> (db_ref * field_out db_record) list
