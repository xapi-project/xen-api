...
type implementation =
  | XenDisk of xendisk  (** This value can be used for ring connection. *)
...
module Datapath (R : RPC) = struct
  ...
  let deactivate =
    declare "deactivate"
      ...
      ; "or writing its disk. This is an opportunity for an implementation \
         which"
      ; "needs to perform an explicit volume handover to do it. This function \
         is"
  ...
  let detach =
    declare "detach"
      ...
      ; "associated with the disk. This function is called outside the \
         migration"
...
let interfaces =
  Codegen.Interfaces.create ~name:"datapath"
