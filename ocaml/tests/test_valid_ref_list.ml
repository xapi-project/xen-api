...
let with_vm_list f () =
  ...
  let vm1 =
    Test_common.make_vm ~__context ~name_label:"a" ~name_description:"d_a" ()
  in
  let vm2 = Ref.null in
  let vm3 =
    Test_common.make_vm ~__context ~name_label:"c" ~name_description:"d_c" ()
  in
  Db.VM.destroy ~__context ~self:vm3 ;
  let vm4 =
    Test_common.make_vm ~__context ~name_label:"d" ~name_description:"d_d" ()
  in
