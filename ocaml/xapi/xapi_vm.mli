...
val set_auto_update_drivers : __context:Context.t -> vm:API.ref_VM -> enable:bool -> unit
val assert_can_set_auto_update_drivers : __context:Context.t -> vm:API.ref_VM -> unit