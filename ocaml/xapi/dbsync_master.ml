...
let create_pool_record ~__context =
	...
	if pools=[] then
		Db.Pool.create ~__context ~ref:(Ref.make()) ~uuid:(Uuid.to_string (Uuid.make_uuid()))
			...
			~guest_agent_config:[]
			~sanlock_freelist:[2L;3L;4L;5L;6L;7L;8L;9L;10L;11L;12L;13L;14L;15L;16L] (* we assume 1 is already taken by the master *) (* TODO define 16 as a constant somewhere *)
