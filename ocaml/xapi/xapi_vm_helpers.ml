...
(* Since take into account the unattached pif's host in host-group,do not need to check the capacity here,
   Empty host group means no suitable hosts for sriov *)
