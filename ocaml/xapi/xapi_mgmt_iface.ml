...
let rewrite_management_interface_script = "/opt/xensource/libexec/rewrite-management-interface"

let script = "/opt/xensource/libexec/rewrite-management-interface"
