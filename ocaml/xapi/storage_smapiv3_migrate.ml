...
module MIRROR : SMAPIv2_MIRROR = struct
  ...
  let receive_finalize _ctx ~dbg:_ ~id:_ = Storage_interface.unimplemented __FUNCTION__

  let receive_finalize2 _ctx ~dbg:_ ~id:_ = Storage_interface.unimplemented __FUNCTION__
  ...
  let receive_cancel _ctx ~dbg:_ ~id:_ = Storage_interface.unimplemented __FUNCTION__
