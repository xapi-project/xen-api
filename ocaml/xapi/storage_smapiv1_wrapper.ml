...
functor
  ...
  struct
    ...
    module DATA = struct
      ...
      let mirror _context ~dbg:_ ~sr:_ ~vdi:_ ~vm:_ ~dest:_ = Storage_interface.unimplemented __FUNCTION__

      let stat _context ~dbg:_ ~sr:_ ~vdi:_ ~vm:_ ~key:_ = Storage_interface.unimplemented __FUNCTION__
      ...
      module MIRROR = struct
        ...
        let stat _context ~dbg:_ ~id:_ = Storage_interface.unimplemented __FUNCTION__
      end
    end
