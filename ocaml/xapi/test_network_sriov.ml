...
let test_create_internal () =
  ...
  let sriov, logical_PIF = Xapi_network_sriov.create_internal ~__context ~physical_PIF ~network in
...
let test_create_on_network_not_compatible_sriov () =
  ...
  assert_raises_api_error
    Api_errors.network_incompatible_purposes
...
let test_create_sriov_with_different_pci_type_into_one_network () =
  ...
  Db.PIF.set_capabilities ~__context ~self:pif ~value:["sriov"];
  assert_raises_api_error
    Api_errors.network_sriov_pci_vendor_not_compatible
    ~args:[Ref.string_of pif; Ref.string_of network]
    (fun () -> Xapi_network_sriov.create ~__context ~pif ~network)

let test_need_operate_pci_device_not_attached_not_need_reboot () =
  let __context = make_test_database () in
  let sriov_logical_PIF =
    ...
    sriov_logical_PIF
  in
  assert_equal false (Xapi_network_sriov_helpers.need_operate_pci_device ~__context ~self:sriov_logical_PIF)

let test_need_operate_pci_device_sysfs () =
  ...
  let sriov_logical_PIF =
    ...
    sriov_logical_PIF
  in
  assert_equal true (Xapi_network_sriov_helpers.need_operate_pci_device ~__context ~self:sriov_logical_PIF)

let test_need_operate_pci_device_unknown () =
...
let test_need_operate_pci_device_modprobe_0 () =
...
let test_need_operate_pci_device_modprobe_1 () =
  (* No other sriov has same driver with me.
...
let test_need_operate_pci_device_modprobe_2 () =
...
let test_need_operate_pci_device_modprobe_3 () =
  (* There are 1 other sriov has same driver name with me.
...
let test_need_operate_pci_device_modprobe_4 () =
  (* There are 1 other sriov has same driver name with me.
...
let test_need_operate_pci_device_modprobe_5 () =
  (* There are 1 other sriov has same driver name with me.
...
let test =
  ...
  [
    ...
    "test_need_operate_pci_device_not_attached_not_need_reboot" >:: test_need_operate_pci_device_not_attached_not_need_reboot;
    "test_need_operate_pci_device_sysfs" >:: test_need_operate_pci_device_sysfs;
    "test_need_operate_pci_device_unknown" >:: test_need_operate_pci_device_unknown;
    "test_need_operate_pci_device_modprobe_0" >:: test_need_operate_pci_device_modprobe_0;
    "test_need_operate_pci_device_modprobe_1" >:: test_need_operate_pci_device_modprobe_1;
    "test_need_operate_pci_device_modprobe_2" >:: test_need_operate_pci_device_modprobe_2;
    "test_need_operate_pci_device_modprobe_3" >:: test_need_operate_pci_device_modprobe_3;
    "test_need_operate_pci_device_modprobe_4" >:: test_need_operate_pci_device_modprobe_4;
    "test_need_operate_pci_device_modprobe_5" >:: test_need_operate_pci_device_modprobe_5;
  ]
