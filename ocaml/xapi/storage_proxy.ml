...
module Proxy = functor(RPC: RPC) -> struct
	...
	module VDI = struct
		...
		let set_is_a_snapshot _ = Client.VDI.set_is_a_snapshot
		let set_snapshot_time _ = Client.VDI.set_snapshot_time
		let set_snapshot_of _ = Client.VDI.set_snapshot_of
