...
def wake_on_lan(session, host, broadcast_addr, mac):
...
def main(session, args):
    ...
    this_broadcast_addr = find_interface_broadcast_ip(this_bridge)
    ...
    return wake_on_lan(session, remote_host, this_broadcast_addr, mac)
