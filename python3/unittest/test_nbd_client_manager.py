...
class TestGetPersistentConnectInfoFilename(unittest.TestCase):
    def test_get_persistent_connect_info_filename(self):
        ...
        self.assertEqual(nbd_client_manager._get_persistent_connect_info_filename(device), expected_filename)
...
class TestPersistConnectInfo(unittest.TestCase):
    ...
    def test_persist_connect_info(self, mock_exists, mock_makedirs):
        ...
        mock_file().write.assert_called_once_with('{"path": "/some/path", "exportname": "example_export"}')
...
class TestConnectNbd(unittest.TestCase):
    ...
    def test_connect_nbd(self, mock_open, mock_persist_info, mock_wait_for_nbd, mock_find_unused, mock_call):
        ...
        mock_open.side_effect = [mock_file_scheduler, mock_file_max_sectors_kb, mock_file_nr_requests]
        ...
        mock_persist_info.assert_called_once_with("/dev/nbd0", "/path/of/socket/file", "export_name")
        # Checking open calls
...
class TestDisconnectNbdDevice(unittest.TestCase):
    ...
    def test_disconnect_nbd_device_connected(self, mock_wait_for_nbd, mock_call, mock_remove_persistent, mock_is_connected):
    ...
    def test_disconnect_nbd_device_disconnected(self, mock_wait_for_nbd, mock_call, mock_remove_persistent, mock_is_connected):
    ...
    def test_disconnect_nbd_device_not_found(self, mock_wait_for_nbd, mock_call, mock_remove_persistent, mock_is_connected):
