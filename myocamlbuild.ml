(* OASIS_START *)
(* DO NOT EDIT (digest: 583d1fae3ca1d6a62243d29e718bb219) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("profiling", ["profiling"], []); ("rrdd_libs", ["lib"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_rrdd_libs_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_rrdd_libs_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_rrdd_libs_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_rrdd_libs_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
