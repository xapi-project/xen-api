(* OASIS_START *)
(* DO NOT EDIT (digest: a8d07f7b45c54e6f06c730de8e3d8dd8) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("xapi-database", ["ocaml/database"], []);
          ("xapi-consts", ["ocaml/xapi-consts"], []);
          ("xapi-datamodel", ["ocaml/idl"], []);
          ("xapi-types", ["ocaml/xapi-types"], []);
          ("xapi-client", ["ocaml/xapi-client"], []);
          ("xapi-version", ["ocaml/util"], []);
          ("pam", ["ocaml/auth"], []);
          ("rfb", ["ocaml/rfb"], []);
          ("xapi-cli-protocol", ["ocaml/xapi-cli-protocol"], [])
       ];
     lib_c = [("pam", "ocaml/auth", ["ocaml/auth/xa_auth.h"])];
     flags =
       [
          (["oasis_library_xapi_datamodel_byte"; "ocaml"; "link"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_library_xapi_datamodel_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_library_xapi_datamodel_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          ([
              "oasis_library_xapi_datamodel_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
          ...
          (["oasis_library_xapi_datamodel_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          ...
          (["oasis_executable_gen_api_main_byte"; "ocaml"; "link"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_gen_api_main_native"; "ocaml"; "link"; "native"
           ],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_gen_api_main_byte"; "ocaml"; "ocamldep"; "byte"
           ],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
          ...
          ([
              "oasis_executable_gen_api_main_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
          ...
          (["oasis_executable_gen_api_main_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          ...
          (["oasis_library_pam_ccopt"; "compile"],
            [(OASISExpr.EBool true, S [A "-ccopt"; A "-I/usr/lib64/ocaml"])]);
          (["oasis_library_pam_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lpam"])]);
          (["oasis_library_pam_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lpam"])]);
          (["oasis_executable_xapi_byte"; "ocaml"; "link"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_xapi_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_xapi_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_xapi_native"; "ocaml"; "ocamldep"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_xapi_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ]);
          (["oasis_executable_xapi_native"; "ocaml"; "compile"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-warn-error"; A "+a-3-4-6-9-27-28-29"])
            ])
     ...
     includes =
       [
          ("ocaml/xe-cli", ["ocaml/xapi-cli-protocol"]);
          ("ocaml/xapi-types", ["ocaml/xapi-consts"]);
          ("ocaml/xapi-client", ["ocaml/xapi-types"]);
          ("ocaml/xapi",
            [
               "ocaml/auth";
               "ocaml/idl";
               "ocaml/rfb";
               "ocaml/util";
               "ocaml/xapi-cli-protocol";
               "ocaml/xapi-client";
               "ocaml/xapi-types"
            ]);
          ("ocaml/vncproxy", ["ocaml/xapi-client"]);
          ("ocaml/perftest", ["ocaml/xapi-client"]);
          ("ocaml/mpathalert", ["ocaml/xapi-client"]);
          ("ocaml/license", ["ocaml/xapi-client"]);
          ("ocaml/idl/ocaml_backend", ["ocaml/idl"; "ocaml/xapi-consts"]);
          ("ocaml/idl/json_backend", ["ocaml/idl"; "ocaml/xapi-consts"]);
          ("ocaml/idl", ["ocaml/database"; "ocaml/xapi-consts"]);
          ("ocaml/graph", ["ocaml/idl"; "ocaml/xapi-client"]);
          ("ocaml/events", ["ocaml/xapi-client"]);
          ("ocaml/db_process", ["ocaml/database"; "ocaml/xapi-client"])
       ]
  }
  ;;
