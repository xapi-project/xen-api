...
(* OASIS_START *)
(* DO NOT EDIT (digest: 641181ed340521bebc454d7bf78d91b7) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "xenswitch";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "xenswitch_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenswitch";
                      lib_findlib_name = Some "lwt";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "xenswitch_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "Q\167#\253\186\224\129\169bJ\238\246\173\254\195\176";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
