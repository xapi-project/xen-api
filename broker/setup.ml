...
(* OASIS_START *)
(* DO NOT EDIT (digest: 744527745e43ccbc758d7586f850447a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Protocol"; "Protocol_lwt"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\132E\190\031\228D^\029\011\1448j1\224\144r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
