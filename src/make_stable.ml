...
module Of_stable_format = struct
  module V1
      (Stable_format : sig type t [@@deriving bin_io, sexp] end)
      (M : sig
...
module Of_stable_format1 = struct
  module V1
      (Stable_format : sig type 'a t [@@deriving bin_io, sexp] end)
      (M : sig
...
module Of_stable_format2 = struct
  module V1
      (Stable_format : sig type ('a1, 'a2) t [@@deriving bin_io, sexp] end)
      (M : sig
