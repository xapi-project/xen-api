...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5792256a2dd76a42cf85e44bcd6f0124) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "memory_cli.ml"})
            ];
     ...
     oasis_digest = Some "\251\026E\240\236!\212\127l\227y\238\243 \183$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
