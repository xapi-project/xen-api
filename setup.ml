...
(* OASIS_START *)
(* DO NOT EDIT (digest: c42be88dbaae3585ab148f029843b449) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Api_errors"; "Constants"; "Api_messages"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "xapi-database";
                           InternalLibrary "xapi-consts";
                           FindlibPackage ("rpclib", None);
                           FindlibPackage ("ppx_deriving_rpc", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "ocaml/idl/ocaml_backend";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "xapi-datamodel";
                           InternalLibrary "xapi-consts";
                           FindlibPackage ("stdext", None);
                           FindlibPackage ("sexpr", None);
                           FindlibPackage ("xml-light2", None);
                   ...
                   {exec_custom = false; exec_main_is = "gen_api_main.ml"});
               Library
                 ({
                     cs_name = "xapi-types";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      lib_modules = ["API"; "Ref"; "Event_types"; "Features"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "ocaml/xapi-client";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xapi-types"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Client"; "Event_helper"; "Tasks"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["xa_auth.c"; "xa_auth_stubs.c"; "xa_auth.h"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-I/usr/lib64/ocaml"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lpam"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rfb"; "Rfb_randomtest"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "ocaml/xapi-cli-protocol";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("stdext", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("oPasswd", None);
                           InternalLibrary "pam";
                           FindlibPackage ("pciutil", None);
                           FindlibPackage ("pci", None);
                           FindlibPackage ("xenstore-compat", None);
                           FindlibPackage ("oclock", None);
                           FindlibPackage ("sha", None);
                           FindlibPackage ("tar", None);
                           FindlibPackage ("tar.unix", None);
                           FindlibPackage ("tapctl", None);
                           InternalLibrary "xapi-version";
                           InternalLibrary "xapi-types";
                           InternalLibrary "xapi-client";
                           InternalLibrary "xapi-datamodel";
                           InternalLibrary "xapi-cli-protocol";
                           InternalLibrary "rfb";
                           FindlibPackage ("stdext", None);
                           FindlibPackage ("threads", None);
                   ...
                   {exec_custom = false; exec_main_is = "xapi_main.ml"});
               Executable
                 ({
                     cs_name = "xe";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "newcli.ml"});
               Executable
                 ({
                     cs_name = "mpathalert";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "mpathalert.ml"});
               Executable
                 ({
                     cs_name = "quicktestbin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "xsh.ml"});
               Executable
                 ({
                     cs_name = "cdrommon";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "cdrommon.ml"});
               Executable
                 ({
                     cs_name = "daily-license-check";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "daily_license_check_main.ml"
                   });
               Executable
                 ({
                     cs_name = "xapi-db-process";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "xapi_db_process.ml"});
               Executable
                 ({
                     cs_name = "suite";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "xapi-datamodel";
                           InternalLibrary "xapi-cli-protocol";
                           FindlibPackage ("xapi-test-utils", None);
                           InternalLibrary "rfb";
                           FindlibPackage ("stdext", None);
                           FindlibPackage ("threads", None);
                           FindlibPackage ("xenctrl", None);
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "P\1994\184\021\242/\221\2054\134:\205<\029\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
