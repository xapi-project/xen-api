...
(* OASIS_START *)
(* DO NOT EDIT (digest: e226633a9a35566962d7cb39addb63bc) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_rrdd_monitor", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_rrdd_monitor.ml"
                   });
               Test
                 ({
                     cs_name = "test_rrdd_monitor";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rrd_discover.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\206\154\188wbz\191;os\216\017D\017\155\162";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
