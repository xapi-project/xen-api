...
(* OASIS_START *)
(* DO NOT EDIT (digest: b7f69ac333dd03aa3c8052491bf49146) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\157$\196\021\147\226\181To\186\192\170\206\167Y\238";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
