...
(* OASIS_START *)
(* DO NOT EDIT (digest: 182dce812c8ee5705ec1a67643650962) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rrd2csv.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "m\026~\221c\000\1283Y\007\179\0179\178\175,";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
