...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7ad727657d48d12cf26ec171ac68ed93) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["John Else"];
          homepage = None;
          synopsis = "Program for dumping RRD files";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rrddump.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\234.#\144Jb\204n\133\141B\195\145)jR";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
