...
(* OASIS_START *)
(* DO NOT EDIT (digest: 49691a79e7cc54ec3b1f46f60241c042) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "xen_test.ml"});
               Library
                 ({
                     cs_name = "xcp_memory";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "V\023\003\235|z\212|\254V\027\005\193Z\248)";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
