...
(* OASIS_START *)
(* DO NOT EDIT (digest: 10ca38e6808c6c0a3f32f8a8fcc94ce5) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "xenops_xc_main.ml";
                      exec_target = None;
                      });
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["xenguest_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             ["-lxenctrl-4.1"; "-lxenguest-4.1"; "-lxenstore"
                             ])
                        ];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\203\212@\176\144\"\224\024\023\208e\253\254F\156q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
