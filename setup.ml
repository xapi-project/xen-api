...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee3c028836cb8490a074295e123698ad) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$network_test", []))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "network-libs";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "xcp_networkd";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "network_test.ml"});
               Test
                 ({
                     cs_name = "test_networkd";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "network_cli.ml"});
               Executable
                 ({
                     cs_name = "jsonrpc_dummy";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "networklibs"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "jsonrpc_dummy.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "N\031\177\159p\148\031\214\203#{\193\028\015_\242";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
