...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75f665fce52a19b35a627261cdab7597) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Protocol_unix"; "Scheduler"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "message_switch";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "3B\195\199\200l\176D\172\238{R\205\249\250\249";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
