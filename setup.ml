...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7dbfb038ef75a46be7336c699bc7fe0) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "xenopsd_xen_main.ml"; 
                   });
               Executable
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\181\234/=\000\165\145m%/\207\221\239\014\028,";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
