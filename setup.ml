...
(* OASIS_START *)
(* DO NOT EDIT (digest: e0813c1d54ab90552bb209c20da91d7c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Inventory_globs"; "Inventory"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\161:\007Y\249\157\139s<+H\183\238\021\154$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
