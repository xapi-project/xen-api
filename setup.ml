...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c297062babcdfa98494c3637ee72ad7) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$xenopsd_test", []))];
            ...
            [
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Link against xentoollog (required for xen > 4.7)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "profiling";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xcp.updates", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dbgring.ml"});
               Executable
                 ({
                     cs_name = "set_domain_uuid";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-warn-error"; "+a-3"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-warn-error"; "+a-3"])]
                   },
                   {exec_custom = false; exec_main_is = "set_domain_uuid.ml"});
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ezxenstore", None);
                           InternalLibrary "profiling"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xentoollog", None);
                           FindlibPackage ("xenctrl", None);
                           InternalLibrary "xenopsd";
                           FindlibPackage ("xenstore", None);
                           FindlibPackage ("xenstore.unix", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "xenopsd_test.ml"});
               Test
                 ({
                     cs_name = "xenopsd_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "7&\t\023\221UW\025\173\242\194\132\2552\250{";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
