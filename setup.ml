...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba2e6e96877cca8d57ca867f47eb3269) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Network_config"; "Network_interface"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\240)0H\015$\145v\152\221\128at\239\016\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
