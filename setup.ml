...
(* OASIS_START *)
(* DO NOT EDIT (digest: d41cf4e617baf344a987be6119df758a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "xcp-networkd-interface";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xcp-fhs", None);
                           InternalLibrary "xcp-networkd-interface"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "networkd.ml"; });
               Executable
                 ({
                     cs_name = "networkd_db";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = "networkd_db";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("stdext", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "networkd_db.ml"; });
               Executable
                 ({
                     cs_name = "network_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "network_test.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\239\027\231\184\227c\228\223\165\2413\133\189\003$\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
