...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8b15e1347b9a64456a33d736cbd939f3) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "coverage";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Network_config"; "Network_utils"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\196\216\142i\251!\164t;\014\225\208\002b@n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
