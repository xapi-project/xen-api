...
(* OASIS_START *)
(* DO NOT EDIT (digest: b9a387866cf54f95709806b699497f7d) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build async protocol library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build lwt protocol library";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "message_switch";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "message_switch";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "message_switch_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("rpclib.json", None);
                           FindlibPackage ("rpclib.syntax", None);
                           InternalLibrary "message_switch"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Protocol_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "message_switch";
                      lib_findlib_name = Some "lwt";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "message_switch_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Protocol_unix"; "Protocol_unix_scheduler"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "message_switch";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Clock"; "Relation"; "Q"; "Logging"; "Switch"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "message_switch";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "message_switch";
                           InternalLibrary "message_switch_unix";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "message_switch";
                           InternalLibrary "message_switch_lwt";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.syntax", None);
                           FindlibPackage ("cohttp", None);
                   ...
                   {exec_custom = true; exec_main_is = "link_test_main.ml"});
               Executable
                 ({
                     cs_name = "client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "client_main.ml"});
               Executable
                 ({
                     cs_name = "client_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "message_switch";
                           InternalLibrary "message_switch_async";
                           FindlibPackage ("async", None);
                   ...
                   {exec_custom = true; exec_main_is = "client_async_main.ml"
                   });
               Executable
                 ({
                     cs_name = "client_unix";
                   ...
                   {exec_custom = true; exec_main_is = "client_unix_main.ml"});
               Executable
                 ({
                     cs_name = "server";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "server_main.ml"});
               Executable
                 ({
                     cs_name = "server_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "server_async_main.ml"
                   });
               Executable
                 ({
                     cs_name = "server_unix";
                   ...
                   {exec_custom = true; exec_main_is = "server_unix_main.ml"});
               Executable
                 ({
                     cs_name = "switch";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "message_switch";
                           InternalLibrary "message_switch_lwt";
                           InternalLibrary "message_switch_server";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.syntax", None);
                           FindlibPackage ("cohttp", None);
                   ...
                   {exec_custom = true; exec_main_is = "switch_main.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Ÿ\133j∆F—\016\147V\128Ø<\151ˆ„\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
