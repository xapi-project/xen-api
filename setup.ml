...
(* OASIS_START *)
(* DO NOT EDIT (digest: b2f9da8c736403229a7a3148a1657174) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Cohttp_posix_io"; "Xcp_client"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\221\005\132\184C\031\t\220\252\232\232\226ve<l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
