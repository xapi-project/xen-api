...
(* OASIS_START *)
(* DO NOT EDIT (digest: cdf016d3a8abd04540eae34150f37173) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rrdd_plugin"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "rrdd-plugin";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rrdp_dummy.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\188\024\171\1876f\206\127s\195\201St\231\020\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
