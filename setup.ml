...
(* OASIS_START *)
(* DO NOT EDIT (digest: d8c962bd7d5cd06fd3ab3e25ef85c7d4) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "xcp-rrdd-plugin";
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "\147c\201\\~\183\233\208n\176\253\0300\195}\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
