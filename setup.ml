...
(* OASIS_START *)
(* DO NOT EDIT (digest: a3d3de4432d2d7b43511feca5999a144) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "event_test.ml"});
               Executable
                 ({
                     cs_name = "upload_disk_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "upload_disk.ml"});
               Executable
                 ({
                     cs_name = "watch_metrics_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "watch_metrics.ml"});
               Test
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "$\144U\135§O\020Ü[á%où<¢ì";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
