...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba65957c1d77b43cfcc5c2ef8c910a3f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "dump.ml"; });
               Executable
                 ({
                     cs_name = "switch";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenstore.server", None);
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.syntax", None);
                           FindlibPackage ("cohttp", None);
                   ...
                   {exec_custom = true; exec_main_is = "switch.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some " 9\011G\022\247\166\160m\230\201\128\180\017\150\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
