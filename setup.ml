...
(* OASIS_START *)
(* DO NOT EDIT (digest: 53cc75a66a460c108d34959b02f6c3ec) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_suite.ml"});
               Test
                 ({
                     cs_name = "test_suite";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.0";
     oasis_digest =
       Some "\019\253\154\025\n\147h\015\168N\195\022\251\207\243\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
