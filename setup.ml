...
(* OASIS_START *)
(* DO NOT EDIT (digest: a94935691d3307b93e20fc0c65430db1) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Cohttp_posix_io"; "Xcp_client"; "Xcp_service"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "6\152\168\183\210\153bw:\139\194\146\130 \200f";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
