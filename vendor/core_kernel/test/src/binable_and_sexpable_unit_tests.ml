    ...
    module Test2 =
      Stable_unit_test.Make (struct
        module T = struct
          ...
          include Sexpable.Of_sexpable2.V1(Format)(struct
              type nonrec ('a, 'b) t = ('a, 'b) t
              let to_sexpable = Format.of_t
              let of_sexpable = Format.to_t
            end)
          include Binable.Of_binable2.V1(Format)(struct
              type nonrec ('a, 'b) t = ('a, 'b) t
        ...
        let tests = [
          ...
          (Second "second", "(Right second)", "\001\006second");
            ...
            [ (First Int.min_value, "(Left -4611686018427387904)",
