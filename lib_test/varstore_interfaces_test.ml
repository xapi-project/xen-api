...
module Privileged = struct
  ...
  module T =
    Varstore_privileged_interface.RPC_API (TestOldRpcs (OldPath) (TXmlrpc))
...
module Deprivileged = struct
  ...
  module OldPath = struct
    let test_data_path = "test_data/varstore/deprivileged"
  end

  module C =
    Varstore_deprivileged_interface.RPC_API (GenTestData (GenPath) (TXmlrpc))
  module T =
    Varstore_deprivileged_interface.RPC_API (TestOldRpcs (OldPath) (TXmlrpc))
