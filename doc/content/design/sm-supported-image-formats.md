...
new parameter to `VDI.pool_migrate`. This field accepts a string that specifies a
preferred format (e.g., *qcow2*), ensuring that the VDI is migrated in the correct
format.
