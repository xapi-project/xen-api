...
(* OASIS_START *)
(* DO NOT EDIT (digest: 94458012475687cc3e11962fe7d276df) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("cow", None);
                           FindlibPackage ("cow.syntax", None);
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\155\129Å\130\020\025ßÚ¹``CÄ½ñ\145";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
