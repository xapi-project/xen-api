...
idl: files.cmx types.cmx control.cmx xenops.cmx memory.cmx python.cmx ocaml.cmx html.cmx main.cmx
	${OCAMLFIND} ocamlopt -package xmlm -package unix -linkpkg -g -o idl files.cmx types.cmx control.cmx xenops.cmx memory.cmx python.cmx ocaml.cmx html.cmx main.cmx

toplevel: files.cmo types.cmo control.cmo xenops.cmo memory.cmo python.cmo ocaml.cmo html.cmo
	${OCAMLFIND} ocamlmktop -thread -package xmlm -linkpkg -g -o toplevel files.cmo types.cmo control.cmo xenops.cmo memory.cmo python.cmo ocaml.cmo html.cmo
