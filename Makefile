...
idl: files.cmx types.cmx control.cmx data.cmx xenops.cmx memory.cmx python.cmx ocaml.cmx html.cmx main.cmx
	${OCAMLFIND} ocamlopt -package cow -package xmlm -package unix -linkpkg -g -o idl files.cmx types.cmx control.cmx data.cmx xenops.cmx memory.cmx python.cmx ocaml.cmx html.cmx main.cmx

toplevel: files.cmo types.cmo control.cmo data.cmo xenops.cmo memory.cmo python.cmo ocaml.cmo html.cmo
	${OCAMLFIND} ocamlmktop -thread -package cow -package xmlm -linkpkg -g -o toplevel files.cmo types.cmo control.cmo data.cmo xenops.cmo memory.cmo python.cmo ocaml.cmo html.cmo
